...
test('AD Format filter - Video ads + Image ads count = total ads count', async () => {
...
test('AD Format filter - Image filter shows only IMAGE cards, no VIDEO cards', async () => {
  await adsLibrary.selectAdFormat('Image (Square Packing)');
...
test('AD Format filter - Video filter shows only VIDEO cards, no IMAGE cards', async () => {
  await adsLibrary.selectAdFormat('Video (9:16 Portrait)');
